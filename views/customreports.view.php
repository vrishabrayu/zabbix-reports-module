...
// v4.0 - removed Type and Mem Util columns
...
// Summary cards
$cs = 'background:#fff;border:1px solid #d0d5e0;border-radius:6px;padding:12px 20px;min-width:110px;';
$summary = (new CDiv([
	(new CDiv([(new CDiv((string)$total))->setAttribute('style', 'font-size:24px;font-weight:bold;color:#1a1a2e'), (new CDiv('Total Devices'))->setAttribute('style', 'font-size:11px;color:#888')]))->setAttribute('style', $cs),
	(new CDiv([(new CDiv((string)$up))->setAttribute('style', 'font-size:24px;font-weight:bold;color:#27ae60'), (new CDiv('Devices Up'))->setAttribute('style', 'font-size:11px;color:#888')]))->setAttribute('style', $cs),
	(new CDiv([(new CDiv((string)$down))->setAttribute('style', 'font-size:24px;font-weight:bold;color:#e74c3c'), (new CDiv('Devices Down'))->setAttribute('style', 'font-size:11px;color:#888')]))->setAttribute('style', $cs),
	(new CDiv([(new CDiv($avg_sla . '%'))->setAttribute('style', 'font-size:24px;font-weight:bold;color:#2980b9'), (new CDiv('Avg SLA'))->setAttribute('style', 'font-size:11px;color:#888')]))->setAttribute('style', $cs),
	(new CDiv([(new CDiv((string)$total_problems))->setAttribute('style', 'font-size:24px;font-weight:bold;color:#e67e22'), (new CDiv('Total Problems'))->setAttribute('style', 'font-size:11px;color:#888')]))->setAttribute('style', $cs)
...
$bs = 'padding:6px 14px;border-radius:4px;font-size:12px;text-decoration:none;color:white;margin-right:8px;display:inline-block;';
$export_bar = (new CDiv([
	(new CTag('a', true, 'Export CSV'))->setAttribute('href', $csv_url)->setAttribute('style', $bs . 'background:#27ae60;'),
	(new CTag('a', true, 'Export PDF'))->setAttribute('href', $pdf_url)->setAttribute('target', '_blank')->setAttribute('style', $bs . 'background:#e74c3c;')
]))->setAttribute('style', 'margin-bottom:12px;');

// Table — NO Type, NO Mem Util
